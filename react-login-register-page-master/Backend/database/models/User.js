...
//WE ARE HASING THE PASSWORD and cpassword
// mongoose.schema.pre('save' , async function (next) {
//     console.log("hi i am pree");
//     if(this.isModified('password')){
//         console.log("Hi I am pre password");
//         this.password = await bcrypt.hash(this.pasword , 12)
